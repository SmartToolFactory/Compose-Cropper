        ...
        val transformModifier = Modifier.pointerInput(key) {
            ...
            detectTransformGestures(
                ...
                onGesture = { centroid, pan, zoom, rotate, mainPointer, pointerList ->
                    ...
                    val currentZoom = cropState.zoom
                    val currentPan = cropState.pan
                    val currentRotation = cropState.rotation
...
internal val BaseCropState.DefaultOnDoubleTap: (ZoomLevel) -> Float
    get() = { zoomLevel: ZoomLevel ->
        when (zoomLevel) {
